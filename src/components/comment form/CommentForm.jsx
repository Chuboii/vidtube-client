...
import {Container, Span, Wrapper, Header, Box, Image, Profile, Name, Username, Form, Input, Terms, Emojis, Emo, Inner} from "../comment form/CommentForm.style"
...
export default function CommentForm() {
  ...
  const toggleCommentForm = () => dispatch({type:"TOGGLE_COMMENT_FORM", payload:false})
