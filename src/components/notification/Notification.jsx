import {Container,Time,H2,VideoText, VideoName, Video, Header, Wrapper, Image, Img, Box, Text, Icon, Wrap} from './Notification.style'
...
function Notification() {
    ...
    const toggleNotification = () =>  dispatch({ type: "TOGGLE_NOTIFICAION", payload: false });
    useEffect(() => {
        const getData = async () => {
            try {
