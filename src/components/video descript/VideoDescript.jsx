...
import { Container, Description, FirstPart, Title, SecondPart, UserInfo, Img, Box, Name, SubscribeButton, Icons,Views , LikeButton, Span, ShareButton, MoreButton,Tags,More, SubscriberCount, Time} from '../../components/video descript/VideoDescript.style'
...
function VideoDescript() {
   ...
   const date = new Date(videoInfo !== null ? videoInfo.createdAt : '')
    ...
    useEffect(() => {
        dispatch({ type: "OTHER_USER_DATA", payload: null})
    ...
    const increaseSubscribers = async () => {
        ...
        try {
            ...
            if (currentUser) {
                ...
                dispatch({type:'ERROR', payload:"You are not authenticated"})
            }
    ...
    return (
        ...
        <Container>
            <Description>
               ...
               <Time> {videoInfo ?  formatDistanceToNow(date, {addSuffix: true}) : ""}</Time>
